...
void RenderScene()
{
	...
	g_pLightShader->SetMatrix("WorldMatrix", &matWorld);
	g_pLightShader->SetMatrix("ViewMatrix", &matView);
	g_pLightShader->SetMatrix("ProjectionMatrix", &matProj);
	g_pLightShader->SetVector("WorldLightPosition", &g_WorldLightPos);
	g_pLightShader->SetVector("WorldCameraPosition", &g_WorldCameraPos);
